...
enum opt_code
{
  ...
  OPT_pie = 995,                             /* -pie */
  OPT_pipe = 996,                            /* -pipe */
  OPT_print_file_name_ = 997,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 998,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 999,           /* -print-multi-directory */
  OPT_print_multi_lib = 1000,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1001,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1002,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1003,               /* -print-prog-name= */
  OPT_print_search_dirs = 1004,              /* -print-search-dirs */
  OPT_print_sysroot = 1005,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1006,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1007,                          /* -quiet */
  OPT_r = 1008,                              /* -r */
  OPT_remap = 1009,                          /* -remap */
  OPT_s = 1010,                              /* -s */
  OPT_s_bc_abi = 1011,                       /* -s-bc-abi */
  OPT_save_temps = 1012,                     /* -save-temps */
  OPT_save_temps_ = 1013,                    /* -save-temps= */
  OPT_shared = 1014,                         /* -shared */
  OPT_shared_libgcc = 1015,                  /* -shared-libgcc */
  /* OPT_specs = 1016, */                    /* -specs */
  OPT_specs_ = 1017,                         /* -specs= */
  OPT_static = 1018,                         /* -static */
  OPT_static_libgcc = 1019,                  /* -static-libgcc */
  OPT_static_libgcj = 1020,                  /* -static-libgcj */
  OPT_static_libgfortran = 1021,             /* -static-libgfortran */
  OPT_static_libgo = 1022,                   /* -static-libgo */
  OPT_static_libstdc__ = 1023,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1024, */                /* -std=c++03 */
  OPT_std_c__0x = 1025,                      /* -std=c++0x */
  OPT_std_c__98 = 1026,                      /* -std=c++98 */
  OPT_std_c1x = 1027,                        /* -std=c1x */
  /* OPT_std_c89 = 1028, */                  /* -std=c89 */
  OPT_std_c90 = 1029,                        /* -std=c90 */
  OPT_std_c99 = 1030,                        /* -std=c99 */
  /* OPT_std_c9x = 1031, */                  /* -std=c9x */
  OPT_std_f2003 = 1032,                      /* -std=f2003 */
  OPT_std_f2008 = 1033,                      /* -std=f2008 */
  OPT_std_f95 = 1034,                        /* -std=f95 */
  OPT_std_gnu = 1035,                        /* -std=gnu */
  OPT_std_gnu__0x = 1036,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1037,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1038,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1039, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1040,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1041,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1042, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1043, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1044,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1045, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1046, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1047,                     /* -std=legacy */
  OPT_symbolic = 1048,                       /* -symbolic */
  OPT_t = 1049,                              /* -t */
  OPT_time = 1050,                           /* -time */
  OPT_time_ = 1051,                          /* -time= */
  OPT_traditional = 1052,                    /* -traditional */
  OPT_traditional_cpp = 1053,                /* -traditional-cpp */
  OPT_trigraphs = 1054,                      /* -trigraphs */
  OPT_u = 1055,                              /* -u */
  OPT_undef = 1056,                          /* -undef */
  OPT_v = 1057,                              /* -v */
  OPT_version = 1058,                        /* -version */
  OPT_w = 1059,                              /* -w */
  OPT_wrapper = 1060,                        /* -wrapper */
  OPT_x = 1061,                              /* -x */
  OPT_z = 1062,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

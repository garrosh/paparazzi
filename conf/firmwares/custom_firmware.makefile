...
CFG_CUSTOM_FIRMWARE=$(PAPARAZZI_SRC)/conf/firmwares/subsystems/custom_firmware

SRC_BOARD=boards/$(BOARD)
SRC_FIRMWARE=firmwares/custom_firmware
SRC_SUBSYSTEMS=subsystems

SRC_ARCH=arch/$(ARCH)

CUSTOM_FIRMWARE_INC = -I$(SRC_FIRMWARE) -I$(SRC_BOARD)


ap.ARCHDIR = $(ARCH)

ap.CFLAGS += $(CUSTOM_FIRMWARE_INC)
...
# Telemetry/Datalink
#
# include subsystems/custom_firmware/telemetry_transparent.makefile
# or
# include subsystems/custom_firmware/telemetry_xbee_api.makefile
#
...
#
# include subsystems/custom_firmware/radio_control_ppm.makefile
# or
# include subsystems/custom_firmware/radio_control_spektrum.makefile
#

#
# Actuator choice
#
# include subsystems/custom_firmware/actuators_mkk.makefile
# or
# include subsystems/custom_firmware/actuators_asctec.makefile
# or
# include subsystems/custom_firmware/actuators_asctec_v2.makefile
#

#
# IMU choice
#
# include subsystems/custom_firmware/imu_b2v1.makefile
# or
# include subsystems/custom_firmware/imu_b2v1_1.makefile
# or
# include subsystems/custom_firmware/imu_crista.makefile
#
...
# GPS choice
#
# include subsystems/custom_firmware/gps_ubx.makefile
# or
# include subsystems/custom_firmware/gps_skytraq.makefile
# or
# nothing
#
...
# AHRS choice
#
# include subsystems/custom_firmware/ahrs_cmpl.makefile
# or
# include subsystems/custom_firmware/ahrs_lkf.makefile
#
...
# INS choice
#
# include subsystems/custom_firmware/ins.makefile
# or
# include subsystems/custom_firmware/ins_extended.makefile
#
# extra:
# include subsystems/custom_firmware/ins_hff.makefile
#

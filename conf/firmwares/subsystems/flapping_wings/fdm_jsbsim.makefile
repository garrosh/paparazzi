...
nps.srcs += $(NPSDIR)/nps_main.c                 \
       ...
       $(NPSDIR)/nps_autopilot_flapping_wings.c      \
       $(NPSDIR)/nps_ivy_common.c                \
       $(NPSDIR)/nps_ivy_flapping_wings.c            \
...
nps.srcs += firmwares/flapping_wings/main.c
nps.srcs += mcu.c
...
nps.srcs += $(SRC_FIRMWARE)/flapping_wings_telemetry.c

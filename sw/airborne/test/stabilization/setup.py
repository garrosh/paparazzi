...
includedirs = common_inc_dirs + [path.join(pprz_airborne, "firmwares/sam_test")]
ext_quat_float = Extension("ref_quat_float",
                           sources=['ref_quat_float.pyx',
                                    path.join(pprz_airborne, "firmwares/sam_test/stabilization/stabilization_attitude_ref_quat_float.c")],
...
ext_quat_int = Extension("ref_quat_int",
                         sources=['ref_quat_int.pyx',
                                  ...
                                  path.join(pprz_airborne, "firmwares/sam_test/stabilization/stabilization_attitude_ref_quat_int.c")],
                         include_dirs=includedirs,

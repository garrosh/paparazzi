...
/**
 * @file firmwares/sam_test/autopilot.h
 *
 * Autopilot modes.
 *
 */
...
/** Set Sam_Test commands.
 *  Limit thrust and/or yaw depending of the in_flight
 *  and motors_on flag status
 */
#ifndef SAM_TEST_COMMANDS_YAW_ALWAYS_ENABLED
#define SetSam_TestCommands(_cmd, _in_flight,  _motor_on) { \

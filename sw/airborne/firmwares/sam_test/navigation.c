...
/**
 * @file firmwares/sam_test/navigation.c
 *
 * Sam_Test navigation functions.
 */
...
static void send_nav_status(void) {
  DOWNLINK_SEND_SAM_TEST_NAV_STATUS(DefaultChannel, DefaultDevice,
...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, "SAM_TEST_NAV_STATUS", send_nav_status);

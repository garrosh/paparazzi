...
/**
 * @file firmwares/samTest/autopilot.c
 *
 * Autopilot.
 *
 */
...
static void send_samTest_rc(void) {
...
static void send_samTest_cmd(void) {
...
void autopilot_init(void) {
  ...
  register_periodic_telemetry(DefaultPeriodic, "SAM_TEST_CMD", send_samTest_cmd);
  ...
  register_periodic_telemetry(DefaultPeriodic, "SAM_TEST_RADIO_CONTROL", send_samTest_rc);
#endif
}
...
INFO("Using FAILSAFE_GROUND_DETECT: KILL")
  ...
  if (autopilot_mode == AP_MODE_KILL) {
    ...
    SetsamTestCommands(stabilization_cmd, autopilot_in_flight, autopilot_motors_on);
  }

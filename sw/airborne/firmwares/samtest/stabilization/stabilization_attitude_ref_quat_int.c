...
/**
 * @file firmwares/samTest/stabilization/stabilization_attitude_ref_quat_int.c
 *
...
#include "firmwares/samTest/stabilization/stabilization_attitude_ref_quat_int.h"

...
/** @file firmwares/samTest/stabilization/stabilization_attitude_quat_float.c
...
#include "firmwares/samTest/stabilization/stabilization_attitude_quat_transformations.h"

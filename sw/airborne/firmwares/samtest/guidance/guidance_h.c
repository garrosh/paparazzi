...
/** @file firmwares/samTest/guidance/guidance_h.c
 *  Horizontal guidance for samTests.
 *
 */
...
#include "firmwares/samTest/stabilization/stabilization_attitude_rc_setpoint.h"
#include "firmwares/samTest/navigation.h"

/* for guidance_v_thrust_coeff */
#include "firmwares/samTest/guidance/guidance_v.h"
...
static void send_tune_hover(void) {
  DOWNLINK_SEND_SAM_TEST_TUNE_HOVER(DefaultChannel, DefaultDevice,
...
void guidance_h_init(void) {
  ...
  register_periodic_telemetry(DefaultPeriodic, "SAM_TEST_TUNE_HOVER", send_tune_hover);
#endif
}
